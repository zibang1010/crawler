...
def test_demo():
    ...
    # result = rc1.radd(REDIS_TASK_KEY, json.dumps(item))
    # if result:
    #     print('--->')
    # else:
    #     print('0000000')
    ...
    # result_list = rc1.range(REDIS_TASK_KEY, start=0)
    # for result in result_list:
    # result = rc1.radd(REDIS_TASK_KEY, rusult)
    # result = json.loads(result)

    rc1.pubsub(REDIS_CHANNEL)
