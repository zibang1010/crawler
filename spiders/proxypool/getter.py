...
class Getter(object):
    def __init__(self):
        self.redis = StrictRedis(host="r-wz94l16plax2n2kusdpd.redis.rds.aliyuncs.com", port=REDIS_PORT, password=REDIS_PASSWORD, db=7)
        ...
        while True:
            ...
            if count < PROXY_COUNT:
                ...
                if proxy:
                    ...
                    if self.redis.set(md5, data, ex=ex):
